...
public class D09_RegexEmail2 {
	...
	public static void main(String[] args) {
		...
		//Pattern domainPattern = Pattern.compile("@\\w+\\.\\w+(\\.\\w+)*");
		...
		while(emailMatcher.find()) {
			...
			//System.out.println("after dot: " + emailMatcher.group(3));
		}
		
		//System.out.println(emailList.size() + "" + emailList);
		//System.out.println(domainCountMap);
		
		List<Domain> domainList =  new ArrayList<>(domainCountMap.values());
...
class Domain implements Comparable<Domain>{
	...
	public int compareTo(Domain d) {
		return d.count.compareTo(count);
	}
