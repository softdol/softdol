...
public class GridCalendar extends JFrame implements ActionListener {
	...
	public void dayPrint(int y, int m) {
		...
		for (int i = 1; i <= lastDate; i++) {
			String viewStr = "<html><font color='red'>" + i;
			viewStr += "</font><br> 오픈시간 : ";
			viewStr += "<br> 마감시간 : ";
			viewStr += "<br> 총 매출액 : ";
			viewStr += "</html>";
			JLabel lbl = new JLabel(viewStr, JLabel.CENTER);
			cal.set(y, m - 1, i);
