...
public class MenuRenewal {
	/*	
	 * 	레스토랑을 운영하던 스카피는 코로나19로 인한 불경기를 극복하고자 
	 * 	메뉴를 새로 구성하려고 고민하고 있습니다.
	 * 
		...
		또한, 최소 2명 이상의 손님으로부터 주문된 단품메뉴 조합에 대해서만 코스요리 
		메뉴 후보에 포함하기로 했습니다.
		...
		요리 5개를 주문한 손님이 1명 있지만, 
		최소 2명 이상의 손님에게서 주문된 구성만 코스요리 후보에 들어가므로, 
